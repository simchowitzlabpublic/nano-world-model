...
def find_model(model_name):
    ...
    if "state_dict" in checkpoint:  # supports PyTorch Lightning checkpoints
        ...
        # PyTorch Lightning saves with prefixes like "model.", "vae."
        new_state_dict = {}
    ...
    # torch.compile wraps the module in OptimizedModule, prefixing every key
    # with "_orig_mod.". At inference we load into an eager model, so strip it.
